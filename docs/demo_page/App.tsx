...
const DEMO_SAMPLE_1: AudioTrack[] = [
  { id: 'mix_1', label: 'Mix', src: '/DUO_TOK/duotok_mix_recon.wav' },
  { id: 'vocal_1', label: 'Vocal', src: '/DUO_TOK/duotok_vocal_recon.wav' },
  { id: 'instr_1', label: 'Accompaniment', src: '/DUO_TOK/duotok_accompany_recon.wav' },
];

const DEMO_SAMPLE_2: AudioTrack[] = [
  { id: 'mix_2', label: 'Mix', src: '/DUO_TOK/duotok_mix_recon_2.wav' },
  { id: 'vocal_2', label: 'Vocal', src: '/DUO_TOK/duotok_vocal_recon_2.wav' },
  { id: 'instr_2', label: 'Accompaniment', src: '/DUO_TOK/duotok_accompany_recon_2.wav' },
];
